  ...
  return (
    <div className="h-full flex flex-col bg-bg-light dark:bg-bg-dark text-fg-light dark:text-fg-dark text-sm">
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-bg-light dark:bg-bg-dark border-b border-border-light dark:border-border-dark">
        <span className="text-xs font-medium text-fg-light dark:text-fg-dark">Console Logs</span>
        <button
          onClick={() => setLogs([])}
      ...
      >
        {logs.length === 0 ? (
          <div className="text-muted-light dark:text-muted-dark text-xs">No console logs yet...</div>
        ) : (
          logs.map((log, index) => (
            <div
              key={index}
            ...
            >
              ...
              <span className="text-muted-light dark:text-muted-dark text-xs mr-2">
